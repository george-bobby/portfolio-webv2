        ...
        <div className="flex flex-col h-full justify-between">
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-base text-muted-foreground mb-2 pl-11">mailto.georgebobby@gmail.com</p>
              </div>
              ...
              <div>
                ...
                <p className="text-base text-muted-foreground mb-2 pl-11">+919746095420</p>
              </div>
            </div>
          ...
          <div className="space-y-4 mt-6">
            <Button
              ...
              size="sm"
              className="group/btn bg-primary/20 hover:bg-primary text-primary-foreground transition-all duration-300 w-full flex items-center justify-center gap-2"
            >
            ...
            <a
              ...
              className="group/btn bg-primary/20 hover:bg-primary text-primary-foreground transition-all duration-300 w-full flex items-center justify-center gap-2 py-2 px-4 rounded-md text-sm font-medium"
            >
              <span>Call Now</span>
